...
//        [self setUserIsPreLoggedIn];
    ...
    [homeButtonsContainerBottomSpaceConstraint setConstant:-614.5f];
    [logoImageYPositionConstraint setConstant:.0f];
    [self.view layoutIfNeeded];
    
    
    NSMutableAttributedString* string = [[NSMutableAttributedString alloc] initWithString:@"Servicios" attributes:@{NSForegroundColorAttributeName : [UIColor whiteColor], NSFontAttributeName : [UIFont fontWithName:@"BrandonGrotesque-Light" size:20.f]}];
    
    [servicesBtn setAttributedTitle:string forState:UIControlStateHighlighted];
    
    string = [[NSMutableAttributedString alloc] initWithString:@"Suites" attributes:@{NSForegroundColorAttributeName : [UIColor whiteColor], NSFontAttributeName : [UIFont fontWithName:@"BrandonGrotesque-Light" size:20.f]}];
    
    [roomsBtn setAttributedTitle:string forState:UIControlStateHighlighted];
    
    string = [[NSMutableAttributedString alloc] initWithString:@"Registro" attributes:@{NSForegroundColorAttributeName : [UIColor whiteColor], NSFontAttributeName : [UIFont fontWithName:@"BrandonGrotesque-Light" size:20.f]}];
    
    [registerProfileBtn setAttributedTitle:string forState:UIControlStateHighlighted];
}
...
- (void)viewDidAppear:(BOOL)animated{
    ...
    CGFloat offsetY = 125.f;
    if ([UIScreen mainScreen].bounds.size.height == 480) {
        offsetY = 100.f;
    }
    [logoImageYPositionConstraint setConstant:offsetY];
...
- (IBAction)serviceNavBarBackBtn:(UIBarButtonItem *)sender {
    ...
    [serviceButtonsContainerBottomSpaceConstraint setConstant:-614.5f];
