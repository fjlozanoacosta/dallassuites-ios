...
- (void)viewDidLoad {
    ...
    UIColor* brown = [UIColor colorWithRed:50.f/255.f green:43.f/255.f blue:38.f/255.f alpha:1.f];
    [room360WebView setBackgroundColor:brown];
    
//    
//    [room360WebView setBackgroundColor:[UIColor greenColor]];
//    [room360WebView setOpaque:NO];
//    [room360WebView loadHTMLString:myString baseURL:nil];
