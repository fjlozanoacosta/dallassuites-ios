...
- (void)awakeFromNib {
    ...
    // Initialization code
    [_roomBriefDescription setVerticalAlignment:BTVerticalAlignmentTop];
    [_roomBriefDescription setLineBreakMode:NSLineBreakByWordWrapping];
    [_roomBriefDescription setNumberOfLines:0];
